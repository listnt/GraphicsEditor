...
// include: /tmp/emscripten_temp/tmp1nigssa3.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/aidar/CLionProjects/BizierEditor/build/BizierEditor.data';
      var REMOTE_PACKAGE_BASE = 'BizierEditor.data';
...
Module['FS_createPath']("/", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/home/aidar/CLionProjects/BizierEditor/build/BizierEditor.data');

      };
      Module['addRunDependency']('datafile_/home/aidar/CLionProjects/BizierEditor/build/BizierEditor.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/.frag", "start": 0, "end": 116}, {"filename": "/shaders/.vert", "start": 116, "end": 480}, {"filename": "/shaders/picking.frag", "start": 480, "end": 597}, {"filename": "/shaders/picking.vert", "start": 597, "end": 1144}], "remote_package_size": 1144});

  })();

// end include: /tmp/emscripten_temp/tmp1nigssa3.js
// include: /tmp/emscripten_temp/tmpml4idaob.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/emscripten_temp/tmpml4idaob.js
// include: /tmp/emscripten_temp/tmpxq4n2gt4.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/emscripten_temp/tmpxq4n2gt4.js
...
function findWasmBinary() {
    return locateFile('BizierEditor.wasm');
}
...
var ASM_CONSTS = {
 ...
 189830: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 190818: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 190901: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 190970: () => { return window.innerWidth; },  
 191000: () => { return window.innerHeight; }
};
...
var _init = Module['_init'] = createExportWrapper('init', 3);
...
var ___heap_base = Module['___heap_base'] = 207424;
